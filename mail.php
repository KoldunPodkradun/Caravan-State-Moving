...
if (!empty($_POST)) {
$to = 'info@caravanstatemoving.com';
$subject = 'Caravan State Moving';
...
<head>
  ...
  <title>Caravan State Moving</title>
  <style>
...
$headers .= "From: Caravan State Moving <info@caravanstatemoving.com>\r\n";
if($phone!=''||$email!='') {
